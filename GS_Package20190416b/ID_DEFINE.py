...
ID_TOOLBAR_LAST=ID_LAYOUT_PARAMETER_SETUP
...
STATE_DRILLING = 50
STATE_EDGE_MILLING = 55
STATE_FAKE_BLINDS_MACHINE = 57
STATE_SPECIAL_SHAPED_SAND_MACHINE = 60
STATE_REGULA_LAYOUT = 65
STATE_LAYERING = 70
STATE_ATTACHE_COMPONENT_MACHINE = 72
STATE_REWORK_INITIAL = 74
STATE_POLISHING = 75
...
STATE_MEMBRANE = 100
STATE_FIRST_QUALITY_INSPECTION = 110
STATE_ASSEMBLE_PARTS_MACHINE = 112
STATE_ASSEMBLE = 113
STATE_ARCHAIZE = 114
STATE_QUALITY_TESTING = 115
STATE_SHELF_AFTER_MEMBRANE = 118
STATE_PACKAGE = 120
STATE_HARD_PACKAGE = 121
STATE_WAREHOUSE = 123
STATE_WAREHOUSED = 125
GENERATING_INVOICE = 127
OUT_OF_THE_TREASURY = 128
STATE_DELIVERY = 130
STATE_DELIVERYING = 150
STATE_INSTALLING = 160
STATE_AFTER_SALE_SERVICE = 170
STATE_GUARANTEE_FINISH = 180
STATE_REPORT_ERROR = 1000
STATE_REPORT_ERROR_RESERVE = 1003
STSTE_STATISTICAL_ERROR_REPORT = 1004
STATE_ERROR_ON_DEALING = 1005
STATE_STATISTICAL_REWORK_VOLUME = 1007
STATE_SCRAP = 1010
...
PACKAGE_PRINT_BAR_CODE_HARD_PACKAGE = 110
PACKING_TASK_LIST_STATE_WRONG = 1000
MAX_PACKAGE_NUM_OF_A_PLACE = 2
...
ELEMENT_TYPE_TRUE_BLINDS=12
ELEMENT_TYPE_FAKE_BLINDS=13
ELEMENT_TYPE_GRID=14
ELEMENT_TYPE_BAR = 15
ELEMENT_TYPE_COPPER_STRIP_GLASS = 16
ELEMENT_TYPE_STRAIGHT = 17
ELEMENT_TYPE_DOUBLE_COLOR_BAR = 18
ELEMENT_TYPE_DOUBLE_ROW_CORRIDOR_BRIDGE = 20
...
# user_list = ['chk']
password = '12345678'
database = ['gs_package', 'hanhai_manufacture', 'hanhai_produce', 'hanhai_management']
charset = 'utf8'
...
Cloud_manufacturerDB=['tianjin_hanhai_manufacture','tianjin_hanhai_produce','tianjin_hanhai_management']
